...
void customRule()
{
	...
	scanf("%d", &length);
	printf("Please select a number for the generations down the page \n");
	scanf("%d", &height);
	
	//I based this method on this reference: https://www.programmingsimplified.com/c/source-code/c-program-convert-decimal-to-binary
...
void custom30()
{
	...
	//This asks the user for all the infomation it needs to start and create the automaton
	printf("Please input a number for many colums you would like across the page \n");
	scanf("%d", &length);
	printf("Please input a number for how many generations you would like down the page: \n");
	scanf("%d", &height);
	...
	int ruleMade[8] = {0,1,1,1,1,0,0,0};
...
int menu()
{
	...
	do
	{
		...
		printf("2: Custom rule automatom (up to rule 255)\n");
